...
public class MotionMenuRecyclerAdapter extends RecyclerView.Adapter<MotionMenuRecyclerAdapter.MotionViewHolder> {
...
private MotionTextSelectListener mMotionTextSelectListener=null;
    ...
    public MotionMenuRecyclerAdapter(List<String> list) {
        this.list = list;
    }
